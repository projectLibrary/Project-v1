 ...
 useEffect(() => {
  ...
  return (
    ...
    <div>
      ...
      <MDBTable striped hover style={{ borderRadius: "7px", width: "700",marginTop:"30px",marginLeft:"10px", boxShadow: '2px 2px 2px #9a9a9a' }}>
        ...
        <MDBTableHead>
          <tr>
            ...
            <th scope='col' style={{width:'700px', textAlign:'center'}}>Action</th>
          </tr>
        </MDBTableHead>
        <MDBTableBody>
